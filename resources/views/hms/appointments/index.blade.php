                ...
                <div class="d-sm-flex align-items-center justify-content-between">
                    <div>
                        <h2 class="text-white mb-2 fw-bold">
                            <i class="fas fa-calendar-check me-3"></i>Manage Appointments
                        </h2>
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-0 fw-bold" style="color: #6366f1;">{{ $todayCount ?? 0 }}</h2>
                        </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-0 fw-bold" style="color: #f59e0b;">{{ $pendingCount ?? 0 }}</h2>
                        </div>
                        <div class="stats-icon">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stats-card card border-0 shadow-sm h-100" style="transition: all 0.3s ease;">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="flex-grow-1">
                            <h6 class="text-muted text-uppercase mb-2 small">Confirmed</h6>
                            <h2 class="mb-0 fw-bold" style="color: #10b981;">{{ $confirmedCount ?? 0 }}</h2>
                        </div>
                        <div class="stats-icon">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stats-card card border-0 shadow-sm h-100" style="transition: all 0.3s ease;">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="flex-grow-1">
                            <h6 class="text-muted text-uppercase mb-2 small">Cancelled</h6>
                            <h2 class="mb-0 fw-bold" style="color: #ef4444;">{{ $cancelledCount ?? 0 }}</h2>
                        </div>
                        <div class="stats-icon">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom py-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('hms.appointments.create') }}" class="btn btn-primary" style="background: linear-gradient(135deg, #ec4899 0%, #db2777 100%); border: none;">
            ...
            <tbody>
                                    @foreach($appointments as $appointment)
                                        <tr>
                                            <td class="px-4 py-3">
                                                <div>
                                                    <div class="fw-bold text-dark">{{ \Carbon\Carbon::parse($appointment->scheduled_at ?? $appointment->appointment_date)->format('M d, Y') }}</div>
                        ...
                        <div class="text-center py-5 my-5">
                            <div class="mb-4">
                                <div class="mx-auto rounded-circle d-flex align-items-center justify-content-center" 
                                    ...
                                    <i class="fas fa-calendar-times" style="font-size: 3rem; color: #ec4899;"></i>
                                </div>
                            </div>
                            <h4 class="text-dark mb-3 fw-bold">No Appointments Found</h4>
                            <p class="text-muted mb-4">Get started by creating a new appointment</p>
                            <a href="{{ route('hms.appointments.create') }}" class="btn btn-primary btn-lg px-5" style="background: linear-gradient(135deg, #ec4899 0%, #db2777 100%); border: none;">
                                <i class="fas fa-plus-circle me-2"></i>New Appointment
                            </a>
                        </div>
                    @endif
