...
<div class="container-fluid py-6">
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage laboratory technical staff</p>
        </div>
        <a href="{{ route('hms.staff.lab-technicians.create') }}" class="px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-lg shadow-md transition">
            <i class="fa-solid fa-plus mr-2"></i> Add Lab Technician
        </a>
    </div>
