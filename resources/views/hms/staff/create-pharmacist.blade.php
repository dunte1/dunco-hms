    ...
    <div class="max-w-3xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white flex items-center">
                <i class="fa-solid fa-user-plus text-green-600 mr-3"></i> Add Pharmacist
            </h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Register a new pharmacist</p>
        </div>
        ...
        <form method="POST" action="{{ route('hms.staff.pharmacists.store') }}">
            @csrf
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="gender" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-green-500 focus:border-green-500">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" rows="2" required
                            class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-green-500 focus:border-green-500">{{ old('address') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="qualification" value="{{ old('qualification') }}" required
                            class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-green-500 focus:border-green-500"
                            placeholder="e.g., B.Pharm, Pharm.D">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select name="shift" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-green-500 focus:border-green-500">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('hms.staff.pharmacists') }}" class="px-6 py-3 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 font-semibold rounded-lg hover:bg-gray-300 transition">
                    Cancel
                </a>
            </div>
        </form>
