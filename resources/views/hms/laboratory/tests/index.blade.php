        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage available laboratory tests and pricing</p>
                </div>
                <a href="{{ route('hms.laboratory.tests.create') }}" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition">
                ...
                <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold mt-2">{{ $labTests->total() }}</p>
                        </div>
                        <div class="p-3 bg-white bg-opacity-30 rounded-lg">
                            <i class="fa fa-vial text-2xl"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold mt-2">{{ $labTests->where('is_active', true)->count() }}</p>
                        </div>
                        <div class="p-3 bg-white bg-opacity-30 rounded-lg">
                ...
                <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold mt-2">{{ $labTests->unique('lab_category_id')->count() }}</p>
                        </div>
                        <div class="p-3 bg-white bg-opacity-30 rounded-lg">
                ...
                <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold mt-2">${{ number_format($labTests->avg('price') ?? 0, 0) }}</p>
                        </div>
                        <div class="p-3 bg-white bg-opacity-30 rounded-lg">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 mb-6">
                <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        <a href="{{ route('hms.laboratory.tests.index') }}" class="block w-full px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white text-center rounded-lg">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center">
                                                <i class="fa fa-vial text-blue-600 dark:text-blue-400"></i>
                                            </div>
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $test->test_name }}</div>
                                                <div class="text-sm text-gray-500 dark:text-gray-400">{{ $test->test_code ?? 'N/A' }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-2">
                                            <a href="{{ route('hms.laboratory.tests.show', $test) }}" 
                                               class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300"
                                               title="View Details">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="{{ route('hms.laboratory.tests.edit', $test) }}" 
                                            ...
                                            <form id="delete-form-{{ $test->id }}" action="{{ route('hms.laboratory.tests.destroy', $test) }}" method="POST" class="hidden">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <i class="fa fa-flask text-6xl text-gray-400 mb-4"></i>
                                        <p class="text-lg font-medium text-gray-900 dark:text-white">No laboratory tests found</p>
                                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">Add your first test to get started</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
