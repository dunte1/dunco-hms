    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Create a new insurance provider</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                ...
                <form method="POST" action="{{ route('hms.insurance.providers.store') }}" class="p-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="policy_number_prefix" value="{{ old('policy_number_prefix') }}"
                                   class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" rows="2" 
                                      class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500">{{ old('address') }}</textarea>
                        </div>

                        <!-- Coverage Limit -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Coverage Limit ($)</label>
                            <input type="number" name="coverage_limit" step="0.01" value="{{ old('coverage_limit') }}"
                                   class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="copayment_percentage" step="0.01" min="0" max="100" value="{{ old('copayment_percentage') }}"
                                   class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="deductible_amount" step="0.01" value="{{ old('deductible_amount') }}"
                                   class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="url" name="claim_submission_url" value="{{ old('claim_submission_url') }}"
                                   class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="notes" rows="3" 
                                      class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500">{{ old('notes') }}</textarea>
                        </div>
                    ...
                    <div class="flex gap-4 mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <button type="submit" class="flex-1 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition">
                            <i class="fa fa-save mr-2"></i> Create Provider
                        </button>
                        <a href="{{ route('hms.insurance.providers.index') }}" class="px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg transition">
