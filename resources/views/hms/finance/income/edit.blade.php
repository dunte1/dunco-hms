    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('hms.finance.income.update', $income) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" value="{{ $income->income_number }}" disabled
                            ...
                            <div>
                                ...
                                <select name="income_category" required
                                    ...
                                    <option value="patient_services" {{ old('income_category', $income->income_category) == 'patient_services' ? 'selected' : '' }}>Patient Services</option>
                                    <option value="pharmacy_sales" {{ old('income_category', $income->income_category) == 'pharmacy_sales' ? 'selected' : '' }}>Pharmacy Sales</option>
                                    <option value="lab_tests" {{ old('income_category', $income->income_category) == 'lab_tests' ? 'selected' : '' }}>Lab Tests</option>
                                    <option value="radiology" {{ old('income_category', $income->income_category) == 'radiology' ? 'selected' : '' }}>Radiology</option>
                                    <option value="consultation_fees" {{ old('income_category', $income->income_category) == 'consultation_fees' ? 'selected' : '' }}>Consultation Fees</option>
                                    <option value="admission_fees" {{ old('income_category', $income->income_category) == 'admission_fees' ? 'selected' : '' }}>Admission Fees</option>
                                    <option value="surgery_fees" {{ old('income_category', $income->income_category) == 'surgery_fees' ? 'selected' : '' }}>Surgery Fees</option>
                                    <option value="ambulance_services" {{ old('income_category', $income->income_category) == 'ambulance_services' ? 'selected' : '' }}>Ambulance Services</option>
                                    <option value="other" {{ old('income_category', $income->income_category) == 'other' ? 'selected' : '' }}>Other</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" name="amount" value="{{ old('amount', $income->amount) }}" required min="0" step="0.01"
                            ...
                            <div>
                                ...
                                <select name="payment_method" required
                                    ...
                                    <option value="m_pesa" {{ old('payment_method', $income->payment_method) == 'm_pesa' ? 'selected' : '' }}>M-Pesa</option>
                                    <option value="insurance" {{ old('payment_method', $income->payment_method) == 'insurance' ? 'selected' : '' }}>Insurance</option>
                                </select>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" rows="2"
                                          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">{{ old('description', $income->description) }}</textarea>
                            </div>

                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Notes</label>
                                <textarea name="notes" rows="2"
                                          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">{{ old('notes', $income->notes) }}</textarea>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="is_recurring" value="1" {{ old('is_recurring', $income->is_recurring) ? 'checked' : '' }}
                            ...
                            <div id="recurringFields" style="display: {{ $income->is_recurring ? 'block' : 'none' }};">
                                ...
                                <select name="recurring_frequency"
                                    ...
                                    <option value="daily" {{ old('recurring_frequency', $income->recurring_frequency) == 'daily' ? 'selected' : '' }}>Daily</option>
                                    <option value="weekly" {{ old('recurring_frequency', $income->recurring_frequency) == 'weekly' ? 'selected' : '' }}>Weekly</option>
                                    <option value="monthly" {{ old('recurring_frequency', $income->recurring_frequency) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                    <option value="yearly" {{ old('recurring_frequency', $income->recurring_frequency) == 'yearly' ? 'selected' : '' }}>Yearly</option>
                                </select>
                            </div>
                        </div>
