    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('hms.finance.expenses.update', $expense) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" value="{{ $expense->expense_number }}" disabled
                            ...
                            <div>
                                ...
                                <select name="payment_method" required
                                    ...
                                    <option value="m_pesa" {{ old('payment_method', $expense->payment_method) == 'm_pesa' ? 'selected' : '' }}>M-Pesa</option>
                                </select>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" rows="3" required
                                          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 @error('description') border-red-500 @enderror">{{ old('description', $expense->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="notes" rows="2"
                                          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">{{ old('notes', $expense->notes) }}</textarea>
                            </div>
                        </div>
