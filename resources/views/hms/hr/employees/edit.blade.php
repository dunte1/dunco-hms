        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route('hms.hr.employees.update', $employee) }}" method="POST" id="employeeForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if($employee->photo)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $employee->photo) }}" alt="Current Photo" style="max-width: 150px; max-height: 150px; border-radius: 8px; border: 2px solid #ddd;">
                                        </div>
                                    @endif
                                    <div class="input-group">
                                        <span class="input-group-text bg-white border-end-0">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control form-control-lg @error('emergency_contact') is-invalid @enderror" 
                                              ...
                                              placeholder="Name, Relationship, Phone Number">{{ old('emergency_contact', $employee->emergency_contact) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="alert alert-info d-flex align-items-center mb-3">
                                ...
                                <div>
                                    This employee has a user account. 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-start-0 @error('next_of_kin_name') is-invalid @enderror" 
                                               id="next_of_kin_name" name="next_of_kin_name" value="{{ old('next_of_kin_name', $employee->next_of_kin_name) }}" 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-start-0 @error('next_of_kin_relationship') is-invalid @enderror" 
                                               id="next_of_kin_relationship" name="next_of_kin_relationship" value="{{ old('next_of_kin_relationship', $employee->next_of_kin_relationship) }}" 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-start-0 @error('next_of_kin_contact') is-invalid @enderror" 
                                               id="next_of_kin_contact" name="next_of_kin_contact" value="{{ old('next_of_kin_contact', $employee->next_of_kin_contact) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select form-select-lg border-start-0 @error('supervisor_id') is-invalid @enderror" 
                                            ...
                                            <option value="{{ $emp->id }}" {{ old('supervisor_id', $employee->supervisor_id) == $emp->id ? 'selected' : '' }}>{{ $emp->first_name }} {{ $emp->last_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('supervisor_id')
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control form-control-lg @error('contract_start_date') is-invalid @enderror" 
                                           id="contract_start_date" name="contract_start_date" value="{{ old('contract_start_date', $employee->contract_start_date?->format('Y-m-d')) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control form-control-lg @error('contract_end_date') is-invalid @enderror" 
                                           id="contract_end_date" name="contract_end_date" value="{{ old('contract_end_date', $employee->contract_end_date?->format('Y-m-d')) }}">
                        ...
                        <div class="d-flex gap-3 justify-content-end pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-warning btn-lg px-5" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); border: none;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>Updating Employee...';
    });
    ...
    // Toggle password fields when create user account checkbox is checked (for employees without user accounts)
    ...
    if (createUserAccount && passwordGroup && passwordConfirmationGroup) {
