                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <h2 class="text-white mb-2 fw-bold">
                            <i class="fas fa-plus-circle me-3"></i>Create Internship
                        </h2>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route('hms.hr.internships.store') }}" method="POST" id="internshipForm">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <label for="intern_name" class="form-label fw-bold text-dark">Full Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control form-control-lg @error('intern_name') is-invalid @enderror"
                                           id="intern_name" name="intern_name" value="{{ old('intern_name') }}" required>
                                    @error('intern_name') <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <label for="description" class="form-label fw-bold text-dark">Internship Description</label>
                                    <textarea class="form-control form-control-lg @error('description') is-invalid @enderror"
                                              id="description" name="description" rows="4"
                                              placeholder="Describe the internship role and responsibilities...">{{ old('description') }}</textarea>
                        ...
                        <div class="d-flex gap-3 justify-content-end pt-3 border-top">
                            <a href="{{ route('hms.hr.internships.index') }}" class="btn btn-light btn-lg px-5">
                                <i class="fas fa-times me-2"></i>Cancel
                            </a>
                            <button type="submit" class="btn btn-primary btn-lg px-5" style="background: linear-gradient(135deg, #f97316 0%, #ea580c 100%); border: none;">
                                <i class="fas fa-save me-2"></i>Create Internship
                            </button>
                        </div>
                    </form>
                </div>
