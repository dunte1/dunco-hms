...
@section('title', 'Create Performance Appraisal')
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <h2 class="text-white mb-2 fw-bold">
                            <i class="fas fa-chart-line me-3"></i>Create Performance Appraisal
                        </h2>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route('hms.hr.appraisals.store') }}" method="POST" id="appraisalForm">
                        @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg @error('review_period') is-invalid @enderror" 
                                           id="review_period" name="review_period" value="{{ old('review_period') }}" 
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control form-control-lg @error('appraisal_date') is-invalid @enderror" 
                                           id="appraisal_date" name="appraisal_date" value="{{ old('appraisal_date', date('Y-m-d')) }}" required>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control form-control-lg @error('overall_score') is-invalid @enderror" 
                                           id="overall_score" name="overall_score" value="{{ old('overall_score') }}" 
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control form-control-lg @error('strengths') is-invalid @enderror" 
                                              ...
                                              placeholder="List key strengths...">{{ old('strengths') }}</textarea>
                                    @error('strengths')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control form-control-lg @error('areas_for_improvement') is-invalid @enderror" 
                                              ...
                                              placeholder="List areas needing improvement...">{{ old('areas_for_improvement') }}</textarea>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control form-control-lg @error('goals_for_next_period') is-invalid @enderror" 
                                              ...
                                              placeholder="Define clear goals...">{{ old('goals_for_next_period') }}</textarea>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control form-control-lg @error('appraiser_comments') is-invalid @enderror" 
                                              ...
                                              placeholder="Write your assessment comments...">{{ old('appraiser_comments') }}</textarea>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control form-control-lg @error('hr_comments') is-invalid @enderror" 
                                              ...
                                              placeholder="HR department comments...">{{ old('hr_comments') }}</textarea>
                                    @error('hr_comments')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check mt-3">
                                        <input class="form-check-input" type="checkbox" id="promotion_recommended" 
                                               name="promotion_recommended" value="1" {{ old('promotion_recommended') ? 'checked' : '' }}>
                                ...
                                <div class="col-12" id="promotion_notes_group" style="display: none;">
                                    ...
                                    <textarea class="form-control form-control-lg @error('promotion_notes') is-invalid @enderror" 
                                              ...
                                              placeholder="Explain promotion recommendation...">{{ old('promotion_notes') }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (promotionCheckbox) {
        ...
        if (promotionCheckbox.checked) {
            promotionNotesGroup.style.display = 'block';
        }
    }
    ...
    if (overallScore && overallRating && !overallRating.value) {
