    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="page-header-box p-4 rounded-4" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
                <h2 class="text-white mb-0 fw-bold"><i class="fas fa-plus-circle me-3"></i>Create Training Program</h2>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route('hms.hr.training-programs.store') }}" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="category" class="form-control" value="{{ old('category') }}" placeholder="e.g., CPR, Infection Control">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="duration_hours" class="form-control @error('duration_hours') is-invalid @enderror" value="{{ old('duration_hours', 0) }}" min="0" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch mt-4">
                                    <input class="form-check-input" type="checkbox" name="certificate_available" value="1" id="certificate" {{ old('certificate_available') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="certificate">Certificate Available</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Create Training Program
                                </button>
