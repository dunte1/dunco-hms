        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="fa fa-plus mr-2"></i> Create New Job Posting</h4>
                    <a href="{{ route('cms.careers.index') }}" class="btn btn-secondary">
                        <i class="fa fa-arrow-left mr-1"></i> Back
                    </a>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('cms.careers.store') }}">
                        @csrf
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('requirements')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">List the qualifications and requirements for this position</small>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('responsibilities')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">Describe the key responsibilities of this position</small>
                                </div>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-save mr-2"></i> Create Job Posting
                            </button>
                            <a href="{{ route('cms.careers.index') }}" class="btn btn-secondary">
                                Cancel
                            </a>
