        ...
        <div class="col-lg-10 mx-auto">
            <div class="card border-0 shadow-lg">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('cms.home.update') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <textarea 
                                ...
                                rows="15"
                                placeholder="Enter your homepage content here (HTML allowed)...">{{ old('content', $content) }}</textarea>
                            @error('content')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input 
                                    ...
                                    placeholder="Home - {{ config('app.name') }}">
                                @error('meta_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-4">
                                <label for="meta_keywords" class="form-label fw-bold text-dark">Meta Keywords</label>
                                <input 
                                    type="text" 
                                    id="meta_keywords" 
                                    name="meta_keywords" 
                                    ...
                                    placeholder="hospital, medical, healthcare">
                                @error('meta_keywords')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <textarea 
                                ...
                                rows="3"
                                placeholder="A brief description of your homepage...">{{ old('meta_description', $metaDescription) }}</textarea>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> The home page content will be displayed on your website's homepage. 
                            Make sure to use proper HTML formatting for best results.
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <button type="submit" class="btn btn-lg px-5" style="background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%); border: none; color: white;">
