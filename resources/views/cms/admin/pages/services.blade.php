                ...
                <div class="d-sm-flex align-items-center justify-content-between">
                    <div>
                        <h2 class="text-white mb-2 fw-bold">
                            <i class="fas fa-briefcase me-3"></i>Services Page CMS
                        </h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0" style="background: transparent;">
                                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="text-white-50">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="#" class="text-white-50">Frontend CMS</a></li>
                                <li class="breadcrumb-item text-white active">Services Page</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="mt-3 mt-sm-0">
                        <a href="{{ route('services') }}" target="_blank" class="btn btn-light btn-lg px-4">
        ...
        <div class="col-lg-10 mx-auto">
            <div class="card border-0 shadow-lg">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('cms.services.update') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <textarea 
                                ...
                                rows="15"
                                placeholder="Enter your services page content here (HTML allowed)...">{{ old('content', $content) }}</textarea>
                            @error('content')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input 
                                    ...
                                    placeholder="Services - {{ config('app.name') }}">
                                @error('meta_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <textarea 
                                    ...
                                    rows="3"
                                    placeholder="A brief description of your services page...">{{ old('meta_description', $metaDescription) }}</textarea>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> The Services page displays your hospital's medical services. 
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <button type="submit" class="btn btn-lg px-5" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); border: none; color: white;">
