...
<head>
    ...
    <title>Reset Password - {{ config('app.name', 'Dunco HMS') }}</title>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm auth-entrance">
                <div class="mb-6 flex flex-col items-center text-center">
                    ...
                    <h2 class="text-xl font-bold text-gray-900">Reset your password</h2>
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" name="email" type="email" value="{{ $request->email ?? old('email') }}" required
