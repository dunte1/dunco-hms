...
@section('title', 'Front Desk Enquiries')
                ...
                <div class="d-sm-flex align-items-center justify-content-between">
                    <div>
                        <h2 class="text-white mb-2 fw-bold">
                            <i class="fas fa-inbox me-3"></i>Front Desk Enquiries
                        </h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0" style="background: transparent;">
                                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="text-white-50">Dashboard</a></li>
                                <li class="breadcrumb-item text-white active">Enquiries</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="flex-grow-1">
                            <h6 class="text-muted text-uppercase mb-2 small">Total Enquiries</h6>
                            <h2 class="mb-0 fw-bold" style="color: #3b82f6;">{{ $totalEnquiries ?? 0 }}</h2>
                        </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-0 fw-bold" style="color: #10b981;">{{ $todayEnquiries ?? 0 }}</h2>
                        </div>
                        <div class="stats-icon">
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-0 fw-bold" style="color: #f59e0b;">{{ $thisMonthEnquiries ?? 0 }}</h2>
                        </div>
                        <div class="stats-icon">
                        ...
                        <div class="text-center py-5 my-5">
                            <div class="mb-4">
                                <div class="mx-auto rounded-circle d-flex align-items-center justify-content-center" 
                                    ...
                                    <i class="fas fa-inbox" style="font-size: 3rem; color: #3b82f6;"></i>
                                </div>
                            </div>
                            <h4 class="text-dark mb-3 fw-bold">No Enquiries</h4>
                            <p class="text-muted mb-4">There are no enquiries at the moment.</p>
                        </div>
                    @endif
                </div>
            </div>
...
function viewEnquiry(id) {
    // Add functionality to view enquiry details
